...
const Filters = (props) => {
    ...
    useEffect(() => {
        if(props.filters){
            setFilterResults(props.filters);
        }else{
            setFilterResults({
                "CGIAR_Action_Areas": [
                    {
                        "value": "Resilient Agrifood Systems",
                        "freq": 0
                    },
                    {
                        "value": "Genetic Innovation",
                        "freq": 0
                    },
                    {
                ...
                "CGIAR_impact_area": [
                    {
                        "value": "Nutrition, health and food security",
                        "freq": 21
                    },
                    {
                        "value": "Poverty reduction, livelihoods and jobs",
                        "freq": 21
                    },
                    {
                        "value": "Environmental health and biodiversity",
                        "freq": 6
                    },
                    {
                        "value": "Climate adaptation and mitigation",
                        "freq": 5
                    },
                    {
                        "value": "Gender equality, youth and social inclusion",
                        "freq": 5
                    }
                ],
                "Regions": [
        ...
        if(filterResults){
            ...
            if(selectedRole){
                if(selectedRole === "donor" || selectedRole === "project_manager"){
                    setFilters(donorAndProjectManagerFilters);
                }else if(selectedRole === "evaluator" || selectedRole === "km_officer") {
                    setFilters(evaluatorAndKmFilters);
                }else if(selectedRole === "monitoring_officer") {
                    setFilters(monitoringOfficerFilters);
                }else if(selectedRole === "impact_officer") {
                    setFilters(impactOfficerFilters);
                }else if(selectedRole === "user") {
                    setFilters(userFilters);
                }
            }
        }
    }, [props.filters,filterResults, regionsOfImplementationItem, countriesOfImplementationItem, environmentalBenefitsItem, typeOfInnovationItem, businessCategoryItem, technicalFieldItem, governanceTypeItem, opacity1Button, opacity2Button, opacity3Button, opacity4Button, opacity5Button, opacity6Button, opacity7Button, opacity8Button, opacity9Button, opacity10Button, opacity11Button, opacity12Button, opacity13Button, opacity14Button, opacity15Button, opacity16Button, opacity17Button, opacity18Button, opacity19Button,opacity20Button, opacity21Button, opacity22Button, opacity23Button, opacity24Button, opacity25Button]);


    useEffect(()=>{


        let governanceTypeField = props.filters.Gοvernance_type
        ...
        let typeOfInnovationField = props.filters.Type_of_innovation
        ...
        let environmentalBenefitsField = props.filters.Environmental_benefits
        ...
        let countriesOfImplementationField = props.filters.Countries
        ...
        let technicalField = props.filters.Technical_field
        ...
        let regionsField = props.filters.Regions
    ...
    const onFilterChange = (e) => {
        ...
        if(e.target.id === "environmental_benefits"){
            setEnvironmentalBenefitsItem(e.value);
        }
        if(e.target.id === "type_of_innovation"){
            setTypeOfInnovationItem(e.value);
        }
        if(e.target.id === "business_category"){
            setBusinessCategoryItem(e.value);
        }
        if(e.target.id === "technical_field"){
            setTechnicalFieldItem(e.value);
        }
        if(e.target.id === "governance_type"){
            setGovernanceTypeItem(e.value);
        }


    }

    //...Showing the Value and Frequency in Dropdowns...
    //TODO perhaps they should be separated, so the frequency updates when filtering

    const filterOptionValues = (filterArray) => {
        let sortedArray = filterArray.sort((a,b) => (a.freq > b.freq)? -1 : 1);
    ...
    const donorAndProjectManagerFilters = () => {
            ...
            <Card>
                <div className="p-grid p-justify-between">
                    ...
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        ...
                        <MultiSelect filter id="regions_of_implementation" value={regionsOfImplementationItem}  onChange={onFilterChange} options={filterRegionsValues(filterResults.Regions)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Countries of Implementation</p>
                        <MultiSelect filter id="countries_of_implementation" value={countriesOfImplementationItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Countries)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Environmental Benefits</p>
                        <MultiSelect id="environmental_benefits" value={environmentalBenefitsItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Environmental_benefits)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Type of Innovation</p>
                        <MultiSelect id="type_of_innovation" value={typeOfInnovationItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Type_of_innovation)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Business Category</p>
                        <MultiSelect id="business_category" value={businessCategoryItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Business_category)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Technical Field</p>
                        <MultiSelect id="technical_field" value={technicalFieldItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Technical_field)} className="filter-dropdown-analytics" />
                    </div>
                    <div className="p-col-8 p-offset-2 margin-top-20 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by Governance Type</p>
                        <MultiSelect  id="governance_type" value={governanceTypeItem} onChange={onFilterChange} options={filterOptionValues(filterResults.Gοvernance_type)} className="filter-dropdown-analytics" />
                    </div>
                </div>
            ...
            <Card>
                <div className="p-grid p-justify-between">
                    <div className="p-col-8 p-offset-2 responsive-div-sidebar">
                        <p className="filter-headings-analytics">Filter by CGIAR Action Areas</p>
                        <div className="p-col-12">
                            <Button id="system-transformation" style={{opacity: opacity1Button}} className="filter-icons-button margin-right-7" onClick={selectButtonIcon}><img src={cgiar6} width={70}/></Button>
                            <Button id="resilient-agrifood" style={{opacity: opacity2Button}} className="filter-icons-button margin-right-7" onClick={selectButtonIcon}><img src={cgiar7} width={70}/></Button>
                            <Button id="genetic-innovation" style={{opacity: opacity3Button}} className="filter-icons-button margin-right-7" onClick={selectButtonIcon}><img src={cgiar8} width={70}/></Button>
                        </div>
                    </div>
    ...
    const monitoringOfficerFilters = () => {
